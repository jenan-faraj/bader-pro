...
function DonatePageContent({ organizationId = null }) {
  ...
  useEffect(() => {
    ...
    fetchDetails();
  }, [projectId, organizationId, mounted]);
  ...
  // PayPal effect
  useEffect(() => {
    if (!mounted || !paypalLoaded || !paypalRef.current) return;
            ...
            onApprove: async (data, actions) => {
              try {
                ...
                if (res.ok) {
                  ...
                  throw new Error(donationData.message || "فشل حفظ التبرع بعد الدفع");
                }
              } catch (err) {
                console.error(err);
  ...
  }, [formData.paymentMethod, formData.amount, paypalLoaded, mounted]);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-3 text-[#31124b]">جاري تحميل صفحة التبرع...</p>
        </div>
      </div>
    );
  }
    ...
    <div dir="rtl" className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} dir="rtl" className="p-8 space-y-6 bg-gray-50 rtl">
            {/* Step 1 */}
            {step === 1 && (
